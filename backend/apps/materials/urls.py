...
from apps.materials.views import MaterialClassification, CardImport, EvidenceReview, MaterialDetail, MaterialList, VersionDetail, VersionFile, VersionRetry, VersionUpload

urlpatterns = [
    path("materials/", MaterialList.as_view()),
    path("materials/<int:pk>/", MaterialDetail.as_view()),
    path("materials/<int:pk>/classification/", MaterialClassification.as_view()),
